...
class BasicNode(template.Node):
    ...
    def get_response_dict(self, helper, context, is_formset):
        ...
        response_dict = {
            ...
            "%s_method" % form_type: attrs.get("form_method"),
            "%s_style" % form_type: attrs.get("form_style"),
            "%s_tag" % form_type: attrs.get("form_tag"),
            "disable_csrf": attrs.get("disable_csrf"),
            "error_text_inline": attrs.get("error_text_inline"),
            "field_class": attrs.get("field_class"),
            "field_template": attrs.get("field_template"),
            "flat_attrs": attrs.get("flat_attrs"),
            "form_error_title": attrs.get("form_error_title"),
            "form_show_errors": attrs.get("form_show_errors"),
            "form_show_labels": attrs.get("form_show_labels"),
            "formset_error_title": attrs.get("formset_error_title"),
            "help_text_inline": attrs.get("help_text_inline"),
            "html5_required": attrs.get("html5_required"),
            "include_media": attrs.get("include_media"),
